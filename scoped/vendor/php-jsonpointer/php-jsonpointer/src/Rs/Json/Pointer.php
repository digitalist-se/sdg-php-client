...
namespace SdgScoped\Rs\Json;

use SdgScoped\Rs\Json\Pointer\InvalidJsonException;
use SdgScoped\Rs\Json\Pointer\InvalidPointerException;
use SdgScoped\Rs\Json\Pointer\NonexistentValueReferencedException;
use SdgScoped\Rs\Json\Pointer\NonWalkableJsonException;
class Pointer
{
    const POINTER_CHAR = '/';
