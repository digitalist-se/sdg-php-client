...
namespace SdgScoped\PhpParser\Lexer;

use SdgScoped\PhpParser\Error;
use SdgScoped\PhpParser\ErrorHandler;
use SdgScoped\PhpParser\Lexer;
use SdgScoped\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use SdgScoped\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use SdgScoped\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use SdgScoped\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use SdgScoped\PhpParser\Lexer\TokenEmulator\FlexibleDocStringEmulator;
use SdgScoped\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use SdgScoped\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use SdgScoped\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use SdgScoped\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use SdgScoped\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use SdgScoped\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use SdgScoped\PhpParser\Lexer\TokenEmulator\TokenEmulator;
