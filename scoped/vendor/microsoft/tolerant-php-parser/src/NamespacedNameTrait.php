...
trait NamespacedNameTrait
{
    ...
    public function getNamespacedName() : ResolvedName
    {
        ...
        if (!($this instanceof QualifiedName && ($this->parent instanceof NamespaceDefinition || $this->parent instanceof NamespaceUseDeclaration || $this->parent instanceof NamespaceUseClause || $this->parent instanceof NamespaceUseGroupClause))) {
