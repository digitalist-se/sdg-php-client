...
class PhpTokenizer implements TokenStreamProviderInterface
{
    ...
    {
        return $this->pos >= $this->endOfFilePos ? $this->tokensArray[$this->endOfFilePos] : $this->tokensArray[$this->pos++];
    }
     ...
     * @return Token[]
     */
    public static function getTokensArrayFromContent($content, $parseContext = null, $initialPos = 0, $treatCommentsAsTrivia = \true) : array
    {
    ...
    const PARSE_CONTEXT_TO_PREFIX = [ParseContext::SourceElements => "<?php "];
}
