...
use SdgScoped\Microsoft\PhpParser\Node\AnonymousFunctionUseClause;
use SdgScoped\Microsoft\PhpParser\Node\ArrayElement;
use SdgScoped\Microsoft\PhpParser\Node\Attribute;
...
use SdgScoped\Microsoft\PhpParser\Node\ConstElement;
use SdgScoped\Microsoft\PhpParser\Node\Expression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\AnonymousFunctionCreationExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\ArgumentExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\ArrayCreationExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\ArrowFunctionCreationExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\AssignmentExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\BinaryExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\BracedExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\CallExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\CastExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\CloneExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\EmptyIntrinsicExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\ErrorControlExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\EvalIntrinsicExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\ExitIntrinsicExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\IssetIntrinsicExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\MatchExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\MemberAccessExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\ParenthesizedExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\PrefixUpdateExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\PrintIntrinsicExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\EchoExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\ListIntrinsicExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\ObjectCreationExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\ScriptInclusionExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\PostfixUpdateExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\ScopedPropertyAccessExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\SubscriptExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\TernaryExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\ThrowExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\UnaryExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\UnaryOpExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\UnsetIntrinsicExpression;
use SdgScoped\Microsoft\PhpParser\Node\Expression\Variable;
use SdgScoped\Microsoft\PhpParser\Node\Expression\YieldExpression;
use SdgScoped\Microsoft\PhpParser\Node\StaticVariableDeclaration;
use SdgScoped\Microsoft\PhpParser\Node\ClassConstDeclaration;
use SdgScoped\Microsoft\PhpParser\Node\DeclareDirective;
...
use SdgScoped\Microsoft\PhpParser\Node\MatchArm;
use SdgScoped\Microsoft\PhpParser\Node\MissingDeclaration;
use SdgScoped\Microsoft\PhpParser\Node\MissingMemberDeclaration;
use SdgScoped\Microsoft\PhpParser\Node\NamespaceAliasingClause;
use SdgScoped\Microsoft\PhpParser\Node\NamespaceUseGroupClause;
use SdgScoped\Microsoft\PhpParser\Node\NumericLiteral;
use SdgScoped\Microsoft\PhpParser\Node\PropertyDeclaration;
use SdgScoped\Microsoft\PhpParser\Node\ReservedWord;
use SdgScoped\Microsoft\PhpParser\Node\StringLiteral;
use SdgScoped\Microsoft\PhpParser\Node\MethodDeclaration;
use SdgScoped\Microsoft\PhpParser\Node\Parameter;
use SdgScoped\Microsoft\PhpParser\Node\QualifiedName;
use SdgScoped\Microsoft\PhpParser\Node\RelativeSpecifier;
use SdgScoped\Microsoft\PhpParser\Node\SourceFileNode;
use SdgScoped\Microsoft\PhpParser\Node\Statement\ClassDeclaration;
use SdgScoped\Microsoft\PhpParser\Node\Statement\ConstDeclaration;
use SdgScoped\Microsoft\PhpParser\Node\Statement\CompoundStatementNode;
use SdgScoped\Microsoft\PhpParser\Node\Statement\FunctionStaticDeclaration;
use SdgScoped\Microsoft\PhpParser\Node\Statement\GlobalDeclaration;
use SdgScoped\Microsoft\PhpParser\Node\Statement\BreakOrContinueStatement;
use SdgScoped\Microsoft\PhpParser\Node\Statement\DeclareStatement;
use SdgScoped\Microsoft\PhpParser\Node\Statement\DoStatement;
use SdgScoped\Microsoft\PhpParser\Node\Statement\EmptyStatement;
use SdgScoped\Microsoft\PhpParser\Node\Statement\ExpressionStatement;
use SdgScoped\Microsoft\PhpParser\Node\Statement\ForeachStatement;
use SdgScoped\Microsoft\PhpParser\Node\Statement\ForStatement;
use SdgScoped\Microsoft\PhpParser\Node\Statement\FunctionDeclaration;
use SdgScoped\Microsoft\PhpParser\Node\Statement\GotoStatement;
use SdgScoped\Microsoft\PhpParser\Node\Statement\IfStatementNode;
use SdgScoped\Microsoft\PhpParser\Node\Statement\InlineHtml;
use SdgScoped\Microsoft\PhpParser\Node\Statement\InterfaceDeclaration;
use SdgScoped\Microsoft\PhpParser\Node\Statement\NamespaceDefinition;
use SdgScoped\Microsoft\PhpParser\Node\Statement\NamespaceUseDeclaration;
use SdgScoped\Microsoft\PhpParser\Node\Statement\NamedLabelStatement;
use SdgScoped\Microsoft\PhpParser\Node\Statement\ReturnStatement;
use SdgScoped\Microsoft\PhpParser\Node\Statement\SwitchStatementNode;
use SdgScoped\Microsoft\PhpParser\Node\Statement\ThrowStatement;
use SdgScoped\Microsoft\PhpParser\Node\Statement\TraitDeclaration;
use SdgScoped\Microsoft\PhpParser\Node\Statement\TryStatement;
use SdgScoped\Microsoft\PhpParser\Node\Statement\WhileStatement;
use SdgScoped\Microsoft\PhpParser\Node\TraitMembers;
use SdgScoped\Microsoft\PhpParser\Node\TraitSelectOrAliasClause;
use SdgScoped\Microsoft\PhpParser\Node\TraitUseClause;
use SdgScoped\Microsoft\PhpParser\Node\UseVariableName;
use SdgScoped\Microsoft\PhpParser\Node\NamespaceUseClause;
class Parser
{
    ...
    public function __construct()
    {
        ...
        $this->parameterTypeDeclarationTokens = [TokenKind::ArrayKeyword, TokenKind::CallableKeyword, TokenKind::BoolReservedWord, TokenKind::FloatReservedWord, TokenKind::IntReservedWord, TokenKind::StringReservedWord, TokenKind::ObjectReservedWord, TokenKind::NullReservedWord, TokenKind::FalseReservedWord];
        // TODO update spec
    ...
    public function parseSourceFile(string $fileContents, string $uri = null) : SourceFileNode
    {
        ...
        $sourceFile->statementList = \array_merge($sourceFile->statementList, $this->parseList($sourceFile, ParseContext::SourceElements));
    ...
    private function isListTerminator(int $parseContext)
    {
        ...
        switch ($parseContext) {
            ...
            case ParseContext::IfClause2Elements:
                return $tokenKind === TokenKind::ElseIfKeyword || $tokenKind === TokenKind::ElseKeyword || $tokenKind === TokenKind::EndIfKeyword;
            ...
            case ParseContext::CaseStatementElements:
                return $tokenKind === TokenKind::CaseKeyword || $tokenKind === TokenKind::DefaultKeyword;
            case ParseContext::ForStatementElements:
                return $tokenKind === TokenKind::EndForKeyword;
    ...
    private function isValidListElement($context, Token $token)
    {
        ...
        switch ($context) {
            ...
            case ParseContext::SwitchStatementElements:
                return $token->kind === TokenKind::CaseKeyword || $token->kind === TokenKind::DefaultKeyword;
        }
        return \false;
    }
    ...
    private function parseStatementFn()
    {
        return function ($parentNode) {
            ...
            $expressionStatement->expression = $this->parseExpression($expressionStatement, \true);
        ...
        return function ($parentNode) {
            ...
            switch ($token->kind) {
                ...
                case TokenKind::QuestionToken:
                    return $this->parseRemainingPropertyDeclarationOrMissingMemberDeclaration($parentNode, $modifiers, $this->eat1(TokenKind::QuestionToken));
    ...
    {
        $classNode = new ClassDeclaration();
        // TODO verify not nested
        ...
        $classNode->name = $this->eat($this->nameOrReservedWordTokens);
        // TODO should be any
    ...
    private function parseAttributeExpression($parentNode)
    {
        ...
        if (\in_array($this->token->kind, [TokenKind::FunctionKeyword, TokenKind::FnKeyword], \true) || $this->token->kind === TokenKind::StaticKeyword && $this->lookahead([TokenKind::FunctionKeyword, TokenKind::FnKeyword])) {
        ...
        if ($expression instanceof AnonymousFunctionCreationExpression || $expression instanceof ArrowFunctionCreationExpression || $expression instanceof MissingDeclaration) {
    ...
    private function parseAttributeStatement($parentNode)
    {
        ...
        if ($parentNode instanceof ClassMembersNode) {
            ...
            if (\in_array($this->token->kind, [TokenKind::ClassKeyword, TokenKind::TraitKeyword, TokenKind::InterfaceKeyword, TokenKind::AbstractKeyword, TokenKind::FinalKeyword, TokenKind::FunctionKeyword, TokenKind::FnKeyword], \true) || $this->token->kind === TokenKind::StaticKeyword && $this->lookahead([TokenKind::FunctionKeyword, TokenKind::FnKeyword])) {
    ...
    private function parseAttributeGroups($parentNode) : array
    {
        ...
        while ($attributeToken = $this->eatOptional1(TokenKind::AttributeToken)) {
            ...
            $attributeGroup->attributes = $this->parseAttributeElementList($attributeGroup) ?: new MissingToken(TokenKind::Name, $this->token->fullStart);
    ...
    {
        return $this->parseDelimitedList(DelimitedList\AttributeElementList::class, TokenKind::CommaToken, $this->isQualifiedNameStartFn(), $this->parseAttributeFn(), $parentNode, \false);
    }
    ...
    private function parseMethodDeclaration($parentNode, $modifiers)
    {
        ...
        $this->parseFunctionType($methodDeclaration, \true);
    ...
    {
        $result = $this->parseDelimitedList(DelimitedList\QualifiedNameList::class, TokenKind::BarToken, function ($token) {
            return \in_array($token->kind, $this->returnTypeDeclarationTokens, \true) || $this->isQualifiedNameStart($token);
        }, function ($parentNode) {
    ...
    {
        return $this->eatOptional($this->returnTypeDeclarationTokens) ?? $this->parseQualifiedName($parentNode);
    }
    private function tryParseParameterTypeDeclaration($parentNode)
    {
        $parameterTypeDeclaration = $this->eatOptional($this->parameterTypeDeclarationTokens) ?? $this->parseQualifiedName($parentNode);
    ...
    {
        $result = $this->parseDelimitedList(DelimitedList\QualifiedNameList::class, TokenKind::BarToken, function ($token) {
            return \in_array($token->kind, $this->parameterTypeDeclarationTokens, \true) || $this->isQualifiedNameStart($token);
        }, function ($parentNode) {
    ...
    private function isExpressionStartFn()
    {
        return function ($token) {
            switch ($token->kind) {
                ...
                // literal
                case TokenKind::DecimalLiteralToken:
                // TODO merge dec, oct, hex, bin, float -> NumericLiteral
            ...
            return \in_array($token->kind, $this->reservedWordTokens, \true);
        };
    }
    /**
    ...
    private function parseTemplateStringExpression($parentNode)
    {
        ...
        if ($token->kind === TokenKind::VariableName) {
            ...
            if ($token->kind === TokenKind::OpenBracketToken) {
                ...
                if ($token->kind === TokenKind::ArrowToken || $token->kind === TokenKind::QuestionArrowToken) {
    ...
    private function parseTemplateStringSubscriptExpression($postfixExpression) : SubscriptExpression
    {
        ...
        $subscriptExpression->openBracketOrBrace = $this->eat1(TokenKind::OpenBracketToken);
        // Only [] syntax is supported, not {}
        $token = $this->getCurrentToken();
        if ($token->kind === TokenKind::VariableName) {
    ...
    private function isParameterStartFn()
    {
        return function ($token) {
            ...
            // scalar-type
            return \in_array($token->kind, $this->parameterTypeDeclarationTokens, \true);
        };
    }
    /**
     ...
     * @internal
     */
    const QUALIFIED_NAME_START_TOKENS = [TokenKind::BackslashToken, TokenKind::NamespaceKeyword, TokenKind::Name];
    private function isQualifiedNameStart($token)
    {
        return \in_array($token->kind, self::QUALIFIED_NAME_START_TOKENS, \true);
    }
    ...
    private function isQualifiedNameStartForCatchFn()
    {
        return function ($token) {
            ...
            return \in_array($token->kind, self::QUALIFIED_NAME_START_TOKENS, \true) || \in_array($token->kind, $this->reservedWordTokens, \true);
        };
    }
    /**
    ...
    private function parseQualifiedNameFn()
    {
        return function ($parentNode) {
            ...
            $nameParts = $this->parseDelimitedList(DelimitedList\QualifiedNameParts::class, TokenKind::BackslashToken, function ($token) {
                ...
                // a\static::b <-VALID
                // TODO more tests
                return $this->lookahead(TokenKind::BackslashToken) ? \in_array($token->kind, $this->nameOrReservedWordTokens) : \in_array($token->kind, $this->nameOrStaticOrReservedWordTokens);
            }, function ($parentNode) {
                $name = $this->lookahead(TokenKind::BackslashToken) ? $this->eat($this->nameOrReservedWordTokens) : $this->eat($this->nameOrStaticOrReservedWordTokens);
                // TODO support keyword name
                $name->kind = TokenKind::Name;
                // bool/true/null/static should not be treated as keywords in this case
                return $name;
            }, $node);
    ...
    private function parseFunctionType(Node $functionDeclaration, $canBeAbstract = \false, $isAnonymous = \false)
    {
        ...
        $functionDeclaration->name = $isAnonymous ? $this->eatOptional($this->nameOrKeywordOrReservedWordTokens) : $this->eat($this->nameOrKeywordOrReservedWordTokens);
        ...
        if ($isAnonymous && isset($functionDeclaration->name)) {
            ...
            $functionDeclaration->name = new SkippedToken($functionDeclaration->name);
            // TODO instead handle this during post-walk
        }
        $functionDeclaration->openParen = $this->eat1(TokenKind::OpenParenToken);
        $functionDeclaration->parameters = $this->parseDelimitedList(DelimitedList\ParameterDeclarationList::class, TokenKind::CommaToken, $this->isParameterStartFn(), $this->parseParameterFn(), $functionDeclaration);
    ...
    private function parseIfStatement($parentNode)
    {
        ...
        if ($curTokenKind === TokenKind::ColonToken) {
            ...
            if ($curTokenKind !== TokenKind::ScriptSectionEndTag) {
        ...
        // TODO - should be some standard for empty arrays vs. null?
    ...
    private function parseUnaryExpressionOrHigher($parentNode)
    {
        ...
        switch ($token->kind) {
            ...
            case TokenKind::OpenParenToken:
                ...
                if ($this->lookahead([TokenKind::ArrayKeyword, TokenKind::BinaryReservedWord, TokenKind::BoolReservedWord, TokenKind::BooleanReservedWord, TokenKind::DoubleReservedWord, TokenKind::IntReservedWord, TokenKind::IntegerReservedWord, TokenKind::FloatReservedWord, TokenKind::ObjectReservedWord, TokenKind::RealReservedWord, TokenKind::StringReservedWord, TokenKind::UnsetKeyword], TokenKind::CloseParenToken)) {
            ...
            case TokenKind::ThrowKeyword:
                // throw-statement will become an expression in php 8.0
    ...
    private function parseBinaryExpressionOrHigher($precedence, $parentNode)
    {
        ...
        while (\true) {
            ...
            $shouldConsumeCurrentOperator = $associativity === Associativity::Right ? $newPrecedence >= $precedence : $newPrecedence > $precedence;
            ...
            switch ($token->kind) {
                ...
                case TokenKind::QuestionQuestionEqualsToken:
                    ...
                    if ($leftOperand instanceof UnaryOpExpression) {
                        $shouldOperatorTakePrecedenceOverUnary = \true;
                    }
                    break;
            ...
            $leftOperand = $token->kind === TokenKind::QuestionToken ? $this->parseTernaryExpression($leftOperand, $token, $parentNode) : $this->makeBinaryExpression($leftOperand, $token, $byRefToken ?? null, $this->parseBinaryExpressionOrHigher($newPrecedence, null), $parentNode);
     ...
     */
    const KNOWN_ASSIGNMENT_TOKEN_SET = [TokenKind::AsteriskAsteriskEqualsToken => \true, TokenKind::AsteriskEqualsToken => \true, TokenKind::SlashEqualsToken => \true, TokenKind::PercentEqualsToken => \true, TokenKind::PlusEqualsToken => \true, TokenKind::MinusEqualsToken => \true, TokenKind::DotEqualsToken => \true, TokenKind::LessThanLessThanEqualsToken => \true, TokenKind::GreaterThanGreaterThanEqualsToken => \true, TokenKind::AmpersandEqualsToken => \true, TokenKind::CaretEqualsToken => \true, TokenKind::BarEqualsToken => \true, TokenKind::QuestionQuestionEqualsToken => \true];
    ...
    private function shiftUnaryOperands(UnaryExpression $leftOperand, $operatorToken, $byRefToken, $rightOperand, $parentNode)
    {
        ...
        $inner = $this->makeBinaryExpression($leftOperand->operand, $operatorToken, $byRefToken, $rightOperand, $outerUnaryOpExpression);
    ...
    {
        $inner = $this->makeBinaryExpression($leftOperand->rightOperand, $operatorToken, $byRefToken, $rightOperand, $parentNode);
        $outer = $this->makeBinaryExpression($leftOperand->leftOperand, $leftOperand->operator, null, $inner, $parentNode);
        $inner->parent = $outer;
        return $outer;
    }
    ...
    private function parseForStatement($parentNode)
    {
        ...
        $forStatement->forInitializer = $this->parseExpressionList($forStatement);
        // TODO spec is redundant
    ...
    private function parseTryStatement($parentNode)
    {
        ...
        $tryStatement->compoundStatement = $this->parseCompoundStatement($tryStatement);
        // TODO verifiy this is only compound
        $tryStatement->catchClauses = array();
        // TODO - should be some standard for empty arrays vs. null?
    ...
    private function parseCatchClause($parentNode)
    {
        ...
        $catchClause->qualifiedName = $qualifiedNameList[0] ?? null;
        // TODO generate missing token or error if null
        $catchClause->otherQualifiedNameList = \array_slice($qualifiedNameList, 1);
        // TODO: Generate error if the name list has missing tokens
    ...
    {
        $declareDirectiveList = $this->parseDelimitedList(DelimitedList\DeclareDirectiveList::class, TokenKind::CommaToken, function ($token) {
            return $token->kind === TokenKind::Name;
        }, $this->parseDeclareDirectiveFn(), $parentNode, \false);
    ...
    private function parseYieldExpression($parentNode)
    {
        ...
        $yieldExpression->yieldOrYieldFromKeyword = $this->eat(TokenKind::YieldFromKeyword, TokenKind::YieldKeyword);
    ...
    private function parseScriptInclusionExpression($parentNode)
    {
        ...
        $scriptInclusionExpression->requireOrIncludeKeyword = $this->eat(TokenKind::RequireKeyword, TokenKind::RequireOnceKeyword, TokenKind::IncludeKeyword, TokenKind::IncludeOnceKeyword);
    ...
    private function parseEchoStatement($parentNode)
    {
        ...
        $echoExpression->expressions = $this->parseExpressionList($echoExpression);
        $expressionStatement->parent = $parentNode;
    ...
    private function parseListIntrinsicExpression($parentNode)
    {
        ...
        $listExpression->listElements = $this->parseArrayElementList($listExpression, DelimitedList\ListExpressionList::class);
        ...
        return function ($parentNode) {
            ...
            if ($this->checkToken(TokenKind::AmpersandToken)) {
                ...
                if ($this->checkToken(TokenKind::DoubleArrowToken)) {
                    ...
                    $arrayElement->byRef = $this->eatOptional1(TokenKind::AmpersandToken);
                    // TODO not okay for list expressions
                    $arrayElement->elementValue = $this->parseExpression($arrayElement);
                } else {
    ...
    {
        return $this->parseDelimitedList(DelimitedList\ExpressionList::class, TokenKind::CommaToken, $this->isExpressionStartFn(), $this->parseExpressionFn(), $parentExpression);
    }
    ...
    private function parseArrayCreationExpression($parentNode)
    {
        ...
        $arrayExpression->openParenOrBracket = $arrayExpression->arrayKeyword !== null ? $this->eat1(TokenKind::OpenParenToken) : $this->eat1(TokenKind::OpenBracketToken);
        $arrayExpression->arrayElements = $this->parseArrayElementList($arrayExpression, DelimitedList\ArrayElementList::class);
        $arrayExpression->closeParenOrBracket = $arrayExpression->arrayKeyword !== null ? $this->eat1(TokenKind::CloseParenToken) : $this->eat1(TokenKind::CloseBracketToken);
        return $arrayExpression;
    }
    private function parseArrayElementList($listExpression, $className)
    {
        return $this->parseDelimitedList($className, TokenKind::CommaToken, $this->isArrayElementStartFn(), $this->parseArrayElementFn(), $listExpression, \true);
    }
    ...
    private function parseUnaryOpExpression($parentNode)
    {
        ...
        $unaryOpExpression->operator = $this->eat(TokenKind::PlusToken, TokenKind::MinusToken, TokenKind::ExclamationToken, TokenKind::TildeToken);
    ...
    private function parsePostfixExpressionRest($expression, $allowUpdateExpression = \true)
    {
        $tokenKind = $this->getCurrentToken()->kind;
        // `--$a++` is invalid
        if ($allowUpdateExpression && ($tokenKind === TokenKind::PlusPlusToken || $tokenKind === TokenKind::MinusMinusToken)) {
            return $this->parseParsePostfixUpdateExpression($expression);
        }
        // TODO write tons of tests
        if (!($expression instanceof Variable || $expression instanceof ParenthesizedExpression || $expression instanceof QualifiedName || $expression instanceof CallExpression || $expression instanceof MemberAccessExpression || $expression instanceof SubscriptExpression || $expression instanceof ScopedPropertyAccessExpression || $expression instanceof StringLiteral || $expression instanceof ArrayCreationExpression)) {
            return $expression;
        }
        ...
        $tokenKind = $this->getCurrentToken()->kind;
        if ($tokenKind === TokenKind::OpenBraceToken || $tokenKind === TokenKind::OpenBracketToken) {
        ...
        if ($tokenKind === TokenKind::OpenParenToken && !$this->isParsingUnparenthesizedObjectCreationExpression($expression)) {
            ...
            if ($expression instanceof ParenthesizedExpression || $expression instanceof CallExpression || $expression instanceof SubscriptExpression) {
    ...
    private function parseMemberName($parentNode)
    {
        ...
        switch ($token->kind) {
            case TokenKind::Name:
                $this->advanceToken();
                // TODO all names should be Nodes
                return $token;
            case TokenKind::VariableName:
            case TokenKind::DollarToken:
                return $this->parseSimpleVariable($parentNode);
            // TODO should be simple-variable
            case TokenKind::OpenBraceToken:
    ...
    {
        return function ($token) {
            return isset($this->argumentStartTokensSet[$token->kind]) || $this->isExpressionStart($token);
        };
    }
    ...
    private function parseCallExpressionRest($expression)
    {
        ...
        $callExpression->argumentExpressionList = $this->parseArgumentExpressionList($callExpression);
    ...
    private function parseParsePostfixUpdateExpression($prefixExpression)
    {
        ...
        $postfixUpdateExpression->incrementOrDecrementOperator = $this->eat(TokenKind::PlusPlusToken, TokenKind::MinusMinusToken);
    ...
    private function parseSubscriptExpression($expression) : SubscriptExpression
    {
        ...
        $subscriptExpression->accessExpression = $this->isExpressionStart($this->getCurrentToken()) ? $this->parseExpression($subscriptExpression) : null;
        // TODO error if used in a getter
    ...
    private function parseObjectCreationExpression($parentNode)
    {
        ...
        $this->isParsingObjectCreationExpression = \true;
    ...
    {
        return $this->parseDelimitedList(DelimitedList\ArgumentExpressionList::class, TokenKind::CommaToken, $this->isArgumentExpressionStartFn(), $this->parseArgumentExpressionFn(), $parentNode);
    }
    /**
    ...
    private function parseClassInterfaceClause($parentNode)
    {
        ...
        $classInterfaceClause->interfaceNameList = $this->parseQualifiedNameList($classInterfaceClause);
    ...
    {
        return $this->parseDelimitedList(DelimitedList\QualifiedNameList::class, TokenKind::CommaToken, $this->isQualifiedNameStartFn(), $this->parseQualifiedNameFn(), $parentNode);
    }
    private function parseQualifiedNameCatchList($parentNode)
    {
        $result = $this->parseDelimitedList(DelimitedList\QualifiedNameList::class, TokenKind::BarToken, $this->isQualifiedNameStartForCatchFn(), $this->parseQualifiedNameFn(), $parentNode);
    ...
    private function parseNamespaceDefinition($parentNode)
    {
        ...
        if (!$this->checkToken(TokenKind::NamespaceKeyword)) {
            ...
            // TODO only optional with compound statement block
        }
        $namespaceDefinition->compoundStatementOrSemicolon = $this->checkToken(TokenKind::OpenBraceToken) ? $this->parseCompoundStatement($namespaceDefinition) : $this->eatSemicolonOrAbortStatement();
    ...
    {
        return $this->parseDelimitedList(DelimitedList\NamespaceUseClauseList::class, TokenKind::CommaToken, function ($token) {
    ...
    {
        return $this->parseDelimitedList(DelimitedList\NamespaceUseGroupClauseList::class, TokenKind::CommaToken, function ($token) {
            return $this->isQualifiedNameStart($token) || $token->kind === TokenKind::FunctionKeyword || $token->kind === TokenKind::ConstKeyword;
        }, function ($parentNode) {
    ...
    {
        return $this->parseDelimitedList(DelimitedList\TraitSelectOrAliasClauseList::class, TokenKind::SemicolonToken, $this->isQualifiedNameStartFn(), $this->parseTraitSelectOrAliasClauseFn(), $parentNode);
    }
    private function parseTraitSelectOrAliasClauseFn()
    {
        return function ($parentNode) {
            ...
            $traitSelectAndAliasClause->name = $this->parseQualifiedNameOrScopedPropertyAccessExpression($traitSelectAndAliasClause);
            ...
            // TODO accept all modifiers, verify later
            if ($traitSelectAndAliasClause->asOrInsteadOfKeyword->kind === TokenKind::InsteadOfKeyword) {
                ...
                $traitSelectAndAliasClause->targetName = $this->parseQualifiedNameOrScopedPropertyAccessExpression($traitSelectAndAliasClause);
    ...
    private function parseGlobalDeclaration($parentNode)
    {
        ...
        $globalDeclaration->variableNameList = $this->parseDelimitedList(DelimitedList\VariableNameList::class, TokenKind::CommaToken, $this->isVariableNameStartFn(), $this->parseSimpleVariableFn(), $globalDeclaration);
    ...
    private function parseFunctionStaticDeclaration($parentNode)
    {
        ...
        $functionStaticDeclaration->staticVariableNameList = $this->parseDelimitedList(DelimitedList\StaticVariableNameList::class, TokenKind::CommaToken, function ($token) {
            return $token->kind === TokenKind::VariableName;
        }, $this->parseStaticVariableDeclarationFn(), $functionStaticDeclaration);
    ...
    {
        return $this->parseDelimitedList(DelimitedList\ConstElementList::class, TokenKind::CommaToken, function ($token) {
            return \in_array($token->kind, $this->nameOrKeywordOrReservedWordTokens);
        }, $this->parseConstElementFn(), $parentNode);
    }
    private function parseConstElementFn()
    {
        return function ($parentNode) {
            ...
            $this->advanceToken();
            $constElement->name->kind = TokenKind::Name;
            // to support keyword names
    ...
    private function parseCastExpression($parentNode)
    {
        ...
        $castExpression->castType = $this->eat(TokenKind::ArrayCastToken, TokenKind::BoolCastToken, TokenKind::DoubleCastToken, TokenKind::IntCastToken, TokenKind::ObjectCastToken, TokenKind::StringCastToken, TokenKind::UnsetCastToken);
    ...
    private function parseCastExpressionGranular($parentNode)
    {
        ...
        $castExpression->castType = $this->eat(TokenKind::ArrayKeyword, TokenKind::BinaryReservedWord, TokenKind::BoolReservedWord, TokenKind::BooleanReservedWord, TokenKind::DoubleReservedWord, TokenKind::IntReservedWord, TokenKind::IntegerReservedWord, TokenKind::FloatReservedWord, TokenKind::ObjectReservedWord, TokenKind::RealReservedWord, TokenKind::StringReservedWord, TokenKind::UnsetKeyword);
    ...
    private function parseAnonymousFunctionCreationExpression($parentNode)
    {
        ...
        $this->parseFunctionType($anonymousFunctionCreationExpression, \false, \true);
    ...
    private function parseArrowFunctionCreationExpression($parentNode, $staticModifier) : ArrowFunctionCreationExpression
    {
        ...
        if (isset($arrowFunction->name)) {
            ...
            $arrowFunction->name = new SkippedToken($arrowFunction->name);
            // TODO instead handle this during post-walk
        }
        $arrowFunction->openParen = $this->eat1(TokenKind::OpenParenToken);
        $arrowFunction->parameters = $this->parseDelimitedList(DelimitedList\ParameterDeclarationList::class, TokenKind::CommaToken, $this->isParameterStartFn(), $this->parseParameterFn(), $arrowFunction);
    ...
    private function parseAnonymousFunctionUseClause($parentNode)
    {
        ...
        $anonymousFunctionUseClause->useVariableNameList = $this->parseDelimitedList(DelimitedList\UseVariableNameList::class, TokenKind::CommaToken, function ($token) {
        ...
        }, $anonymousFunctionUseClause) ?: new MissingToken(TokenKind::VariableName, $this->token->fullStart);
    ...
    private function parseMatchExpression($parentNode)
    {
        ...
        $matchExpression->arms = $this->parseDelimitedList(DelimitedList\MatchExpressionArmList::class, TokenKind::CommaToken, $this->isMatchConditionStartFn(), $this->parseMatchArmFn(), $matchExpression);
    ...
    {
        return function ($token) {
            return $token->kind === TokenKind::DefaultKeyword || $this->isExpressionStart($token);
        };
    }
    private function parseMatchArmFn()
    {
        return function ($parentNode) {
            ...
            $matchArmConditionList = $this->parseDelimitedList(DelimitedList\MatchArmConditionList::class, TokenKind::CommaToken, $this->isMatchConditionStartFn(), $this->parseMatchConditionFn(), $matchArm);
