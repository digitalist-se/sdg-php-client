...
use SdgScoped\Microsoft\PhpParser\ResolvedName;
...
class QualifiedName extends Node implements NamespacedNameInterface
{
    ...
    public $relativeSpecifier;
    // namespace\
    /** @var array */
    public $nameParts;
    const CHILD_NAMES = ['globalSpecifier', 'relativeSpecifier', 'nameParts'];
    /**
    ...
    {
        return !$this->isFullyQualifiedName() && !$this->isRelativeName() && \count($this->nameParts) > 1;
    ...
    public function getResolvedName($namespaceDefinition = null)
    {
        ...
        if ($this->parent instanceof Node\Statement\NamespaceDefinition && $this->parent->name->getStart() === $this->getStart() || $this->parent instanceof Node\Statement\NamespaceUseDeclaration || $this->parent instanceof Node\NamespaceUseClause || $this->parent instanceof Node\NamespaceUseGroupClause || $this->parent->parent instanceof Node\TraitUseClause || $this->parent instanceof Node\TraitSelectOrAliasClause || $this->parent instanceof TraitSelectOrAliasClause && ($this->parent->asOrInsteadOfKeyword == null || $this->parent->asOrInsteadOfKeyword->kind === TokenKind::AsKeyword)) {
            return null;
        }
        ...
        if ($this->isConstantName()) {
            $resolvedName = $this->tryResolveFromImportTable(
                $constImportTable,
                /* case-sensitive */
                \true
            );
