...
class Parameter extends Node
{
    ...
    /** @var null|Expression */
    public $default;
    const CHILD_NAMES = ['attributes', 'visibilityToken', 'questionToken', 'typeDeclaration', 'otherTypeDeclarations', 'byRefToken', 'dotDotDotToken', 'variableName', 'equalsToken', 'default'];
