 ...
 */
namespace SdgScoped\Composer;

use SdgScoped\Composer\Autoload\ClassLoader;
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('SdgScoped\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
