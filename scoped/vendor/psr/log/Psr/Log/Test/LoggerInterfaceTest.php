...
namespace SdgScoped\Psr\Log\Test;

use SdgScoped\Psr\Log\LoggerInterface;
use SdgScoped\Psr\Log\LogLevel;
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('SdgScoped\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('SdgScoped\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('SdgScoped\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
