...
if (!(\file_exists(__DIR__ . '/../vendor/autoload.php') || \file_exists(__DIR__ . '/../../../autoload.php'))) {
    ...
    \fwrite(\STDERR, 'Autoloader not found. Make sure you run `composer install` before running Phan. See https://github.com/phan/phan#getting-started for more details.');
    exit(1);
}
