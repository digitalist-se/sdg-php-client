...
use SdgScoped\ast;
use SdgScoped\Phan\AST\InferPureVisitor;
...
use SdgScoped\Phan\PluginV3\IssueEmitter;
/**
...
class PureMethodInferrer
{
    ...
    public static function warnNoopVoid(CodeBase $code_base, FunctionInterface $method) : void
    {
        ...
        self::emitPluginIssue($code_base, $method->getContext(), UseReturnValuePlugin::UseReturnValueNoopVoid, 'The function/method {FUNCTION} is declared to return {TYPE} and it has no side effects', [$method->getRepresentationForIssue(), $method->getUnionType()]);
    }
}
