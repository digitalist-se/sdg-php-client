 ...
 */
final class DumpPHPDocPlugin extends PluginV3 implements AnalyzeClassCapability, AnalyzeFunctionCapability, AnalyzeMethodCapability, AnalyzePropertyCapability, FinalizeProcessCapability
{
    /**
    ...
    public function analyzeClass(CodeBase $code_base, Clazz $class) : void
    {
        ...
        $this->recordStub($class, self::generatePHPMarkdownBlock($class->getMarkupDescription()), $description);
    }
    ...
    public function analyzeProperty(CodeBase $code_base, Property $property) : void
    {
        ...
        $this->recordStub($property, self::generatePHPMarkdownBlock($property->getMarkupDescription()), $description);
    }
    /**
     * @param CodeBase $code_base @unused-param
    ...
    public function analyzeMethod(CodeBase $code_base, Method $method) : void
    {
        ...
        $this->recordStub($method, self::generatePHPMarkdownBlock($method->getMarkupDescription()), $description);
    }
    /**
    ...
    public function analyzeFunction(CodeBase $code_base, Func $function) : void
    {
        ...
        $this->recordStub($function, self::generatePHPMarkdownBlock($function->getMarkupDescription()), $description);
    }
    /**
