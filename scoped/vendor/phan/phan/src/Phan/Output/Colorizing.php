...
class Colorizing
{
    public const STYLES = [
        ...
        // Alias of 'reset'
        'reset' => '0',
        // Use 'reset' for the absence of color.
        'bold' => '1',
        'dark' => '2',
        'italic' => '3',
        'underline' => '4',
    ...
    private const ESC_PATTERN = "\x1b[%sm";
    private const ESC_RESET = "\x1b[0m";
     ...
     */
    public static function colorizeTemplate(string $template, array $template_parameters) : string
    {
        $i = 0;
    ...
    public static function colorizeField(string $template_type, $arg) : string
    {
        ...
        if ($fmt_directive === null) {
            \error_log(\sprintf("Unknown template type '%s'. Known template types: %s", $template_type, \implode(', ', \array_keys(Issue::UNCOLORED_FORMAT_STRING_FOR_TEMPLATE))));
            return (string) $arg;
        }
     ...
     * @internal
     */
    public const COLOR_SCHEMES = ['code' => \SdgScoped\Phan\Output\ColorScheme\Code::class, 'default' => self::class, 'eclipse_dark' => \SdgScoped\Phan\Output\ColorScheme\EclipseDark::class, 'light' => \SdgScoped\Phan\Output\ColorScheme\Light::class, 'vim' => \SdgScoped\Phan\Output\ColorScheme\Vim::class, 'light_high_contrast' => \SdgScoped\Phan\Output\ColorScheme\LightHighContrast::class];
    /**
