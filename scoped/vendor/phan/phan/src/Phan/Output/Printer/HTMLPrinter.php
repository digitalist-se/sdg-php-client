...
use SdgScoped\Phan\Output\HTML;
...
final class HTMLPrinter implements IssuePrinterInterface
{
    ...
    public function print(IssueInstance $instance) : void
    {
        ...
        $message = HTML::htmlTemplate($issue->getTemplateRaw(), $instance->getTemplateParameters());
        $prefix = HTML::htmlTemplate("{FILE}:{LINE}", [$instance->getDisplayedFile(), $instance->getLine()]);
