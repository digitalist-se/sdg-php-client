...
class IssueInstance
{
     ...
     */
    public function __construct(Issue $issue, string $file, int $line, array $template_parameters, Suggestion $suggestion = null, int $column = 0)
    {
        $this->issue = $issue;
        $this->file = $file;
        $this->line = $line;
     ...
     */
    private static function generatePlainMessage(Issue $issue, array $template_parameters) : string
    {
        ...
        return \vsprintf($template, self::normalizeTemplateParameters($template_parameters));
    }
    /**
     * @param list<string|int|float|FQSEN|Type|UnionType|TypedElementInterface|UnaddressableTypedElement> $template_parameters
     */
    private static function generateColorizedMessage(Issue $issue, array $template_parameters) : string
    {
