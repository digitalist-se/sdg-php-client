...
use SdgScoped\Phan\LanguageServer\Protocol\MarkupContent;
...
final class GoToDefinitionRequest extends NodeInfoRequest
{
     ...
     */
    public function recordDefinitionElement(CodeBase $code_base, AddressableElementInterface $element, bool $resolve_type_definition_if_needed) : void
    {
    ...
    private function recordFinalDefinitionElement(CodeBase $code_base, AddressableElementInterface $element) : void
    {
    ...
    {
        $this->hover_response = new Hover(new MarkupContent(MarkupContent::MARKDOWN, $markdown));
    }
    /**
     * Precondition: $this->isHoverRequest()
     */
    private function recordHoverTextForElementType(CodeBase $code_base, Context $context, TypedElementInterface $element) : void
    {
     ...
     */
    public function recordDefinitionOfVariableType(CodeBase $code_base, Context $context, Variable $variable) : void
    {
        $this->recordTypeOfElement($code_base, $context, $variable);
    }
    private function recordTypeOfElement(CodeBase $code_base, Context $context, TypedElementInterface $element) : void
    {
     ...
     */
    private function recordDefinitionOfTypeFQSEN(CodeBase $code_base, FQSEN $type_fqsen) : void
    {
