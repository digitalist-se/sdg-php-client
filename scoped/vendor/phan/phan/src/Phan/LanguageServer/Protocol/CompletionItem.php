...
class CompletionItem
{
     ...
     */
    public function __construct(string $label = null, int $kind = null, string $detail = null, string $documentation = null, string $sortText = null, string $filterText = null, string $insertText = null)
    {
    ...
    {
        return new self($data['label'], $data['kind'], $data['detail'], $data['documentation'], $data['sortText'], $data['filterText'], $data['insertText']);
    }
}
