...
class ClientHandler
{
    ...
    public function request(string $method, $params) : Promise
    {
        ...
        return $this->protocolWriter->write(new Protocol\Message(new AdvancedJsonRpc\Request($id, $method, (object) $params)))->then(function () use($id) : Promise {
            $promise = new Promise();
            /**
    ...
    {
        return $this->protocolWriter->write(new Protocol\Message(new AdvancedJsonRpc\Notification($method, (object) $params)));
    }
}
