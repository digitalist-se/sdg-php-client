...
namespace SdgScoped\Phan\LanguageServer\Client;

use SdgScoped\Phan\LanguageServer\ClientHandler;
...
class TextDocument
{
    ...
    {
        return $this->handler->notify('textDocument/publishDiagnostics', ['uri' => $uri, 'diagnostics' => $diagnostics]);
    }
}
