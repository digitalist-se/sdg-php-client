...
use SdgScoped\Phan\LanguageServer\Protocol\CompletionList;
...
final class CompletionRequest extends NodeInfoRequest
{
     ...
     */
    public function __construct(string $uri, Position $position, CompletionContext $completion_context = null)
    {
     ...
     */
    public function recordCompletionElement(CodeBase $code_base, TypedElementInterface $element, string $prefix = null) : void
    {
     ...
     */
    private static function createCompletionItem(CodeBase $code_base, TypedElementInterface $element, ?string $prefix = null) : CompletionItem
    {
        $item = new CompletionItem();
        $item->label = self::labelForElement($element);
        $item->kind = self::kindForElement($element);
        $item->detail = (string) $element->getUnionType() ?: 'mixed';
        // TODO: Better summary
        $item->documentation = null;
        // TODO: Better summary, use phpdoc summary
        $insert_text = null;
