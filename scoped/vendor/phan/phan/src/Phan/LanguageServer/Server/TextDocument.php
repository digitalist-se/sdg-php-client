...
namespace SdgScoped\Phan\LanguageServer\Server;

use InvalidArgumentException;
use SdgScoped\Phan\Config;
use SdgScoped\Phan\LanguageServer\FileMapping;
use SdgScoped\Phan\LanguageServer\LanguageClient;
use SdgScoped\Phan\LanguageServer\LanguageServer;
use SdgScoped\Phan\LanguageServer\Logger;
use SdgScoped\Phan\LanguageServer\Protocol\CompletionContext;
use SdgScoped\Phan\LanguageServer\Protocol\Position;
use SdgScoped\Phan\LanguageServer\Protocol\TextDocumentContentChangeEvent;
use SdgScoped\Phan\LanguageServer\Protocol\TextDocumentIdentifier;
use SdgScoped\Phan\LanguageServer\Protocol\TextDocumentItem;
use SdgScoped\Phan\LanguageServer\Protocol\VersionedTextDocumentIdentifier;
use SdgScoped\Phan\LanguageServer\Utils;
...
class TextDocument
{
     ...
     */
    public function __construct(LanguageClient $client, LanguageServer $server, FileMapping $file_mapping)
    {
        $this->client = $client;
        $this->server = $server;
    ...
    */
    ...
    public function typeDefinition(TextDocumentIdentifier $textDocument, Position $position) : ?Promise
    {
        ...
        return $this->server->awaitDefinition($uri, $position, \true);
    }
    /**
