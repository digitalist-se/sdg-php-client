...
abstract class AbstractFQSEN implements FQSEN, Serializable
{
     ...
     * @return static
     */
    public static abstract function fromFullyQualifiedString(string $fully_qualified_string);
    /**
     ...
     * @return static
     */
    public static abstract function fromStringInContext(string $fqsen_string, Context $context);
    /**
     * @return string
