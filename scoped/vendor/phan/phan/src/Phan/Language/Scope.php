...
abstract class Scope
{
     ...
     * @param int $flags
     */
    public function __construct(Scope $parent_scope, $fqsen, int $flags)
    {
    ...
    public function hasAnyTemplateType() : bool
    {
        ...
        return count($this->template_type_map) > 0 || $this->parent_scope->hasAnyTemplateType();
    }
    /**
    ...
    {
        return \array_merge($this->template_type_map, $this->parent_scope->getTemplateTypeMap());
    }
    /**
     * @return bool
    ...
    {
        return isset($this->template_type_map[$template_type_identifier]) || $this->parent_scope->hasTemplateType($template_type_identifier);
    }
    /**
    ...
    public function getTemplateType(string $template_type_identifier) : TemplateType
    {
        ...
        return $this->template_type_map[$template_type_identifier] ?? $this->parent_scope->getTemplateType($template_type_identifier);
    }
    /**
     * @return string
