...
class NamespaceMapEntry implements \Serializable
{
    ...
    public function __construct(FullyQualifiedGlobalStructuralElement $fqsen, string $original_name, int $lineno)
    {
        $this->fqsen = $fqsen;
    ...
    {
        return \serialize([\get_class($this->fqsen), (string) $this->fqsen, $this->original_name, $this->lineno, $this->is_used]);
    }
    /**
