...
final class TemplateType extends Type
{
     ...
     */
    protected function __construct(string $template_type_identifier, bool $is_nullable)
    {
    ...
    public static function instanceForId(string $id, bool $is_nullable) : TemplateType
    {
        if ($is_nullable) {
            ...
            return $nullable_cache[$id] ?? ($nullable_cache[$id] = new self($id, \true));
        }
        static $cache = [];
    ...
    public function withIsNullable(bool $is_nullable) : Type
    {
        ...
        return self::instanceForId($this->template_type_identifier, $is_nullable);
    }
    /**
     * @return string
