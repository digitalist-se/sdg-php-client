...
class ArrayType extends IterableType
{
    ...
    public static function combineArrayTypesOverriding(UnionType $left, UnionType $right, bool $is_assignment = \false) : UnionType
    {
        ...
        return UnionType::of(ArrayType::combineArrayTypeListsOverriding($left->getTypeSet(), $right->getTypeSet(), $is_assignment, \false), ArrayType::combineArrayTypeListsOverriding($left->getRealTypeSet(), $right->getRealTypeSet(), $is_assignment, \true));
    }
    /**
    ...
    {
        return AssociativeArrayType::fromElementType(MixedType::instance(\false), $this->is_nullable, GenericArrayType::KEY_MIXED);
    }
    /**
