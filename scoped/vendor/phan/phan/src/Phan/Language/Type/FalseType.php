...
final class FalseType extends ScalarType implements LiteralTypeInterface
{
    ...
    {
        return \true;
        // it's always falsey, whether or not it's nullable.
    }
    public function isAlwaysFalsey() : bool
    {
        return \true;
        // FalseType is always falsey, whether or not it's nullable.
    }
    public function isAlwaysFalse() : bool
    {
        return !$this->is_nullable;
        // If it can be null, it's not **always** identical to false
    }
    ...
    {
        return $other->isPossiblyTrue() || $other instanceof TemplateType || !$context->isStrictTypes() && parent::canCastToDeclaredType($code_base, $context, $other);
    }
