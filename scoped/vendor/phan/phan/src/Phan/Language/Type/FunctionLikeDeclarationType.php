...
use SdgScoped\Phan\Language\Scope\ClosedScope;
...
abstract class FunctionLikeDeclarationType extends Type implements FunctionInterface
{
    ...
    public function withIsNullable(bool $is_nullable) : Type
    {
        ...
        return new static($this->file_ref, $this->params, $this->return_type, $this->returns_reference, $is_nullable);
    }
    /**
    ...
    {
        return (new Context())->withFile($this->file_ref->getFile())->withLineNumberStart($this->file_ref->getLineNumberStart());
    }
    ...
    {
        return \in_array($issue_type, $this->getSuppressIssueList(), \true);
    }
    ...
    public function getTemplateTypeExtractorClosure(CodeBase $code_base, TemplateType $template_type) : ?Closure
    {
        ...
        foreach ($this->params as $i => $param) {
            ...
            $closure = TemplateType::combineParameterClosures($closure, static function (UnionType $union_type, Context $context) use($code_base, $i, $param_closure) : UnionType {
                ...
                foreach ($union_type->getTypeSet() as $type) {
                    ...
                    if ($param) {
                        $result = $result->withUnionType($param_closure($param->getNonVariadicUnionType(), $context));
                    }
                }
                return $result;
            });
