...
final class NonEmptyGenericArrayType extends GenericArrayType implements NonEmptyArrayInterface
{
    ...
    public static function fromElementType(Type $type, bool $is_nullable, int $key_type) : GenericArrayType
    {
        ...
        if (!$map->contains($type)) {
            $map->attach($type, new NonEmptyGenericArrayType($type, $is_nullable, $key_type));
        }
    ...
    public function asAssociativeArrayType(bool $can_reduce_size) : ArrayType
    {
        ...
        return NonEmptyAssociativeArrayType::fromElementType($this->element_type, $this->is_nullable, $this->key_type);
    }
    /**
    ...
    {
        return GenericArrayType::fromElementType($this->element_type, $this->is_nullable, $this->key_type);
    }
}
