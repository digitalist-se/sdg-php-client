...
final class GenericIterableType extends IterableType
{
    ...
    public function withTemplateParameterTypeMap(array $template_parameter_type_map) : UnionType
    {
        ...
        if ($new_element_type === $this->element_union_type && $new_key_type === $this->key_union_type) {
    ...
    public function withIsNullable(bool $is_nullable) : Type
    {
        ...
        return self::fromKeyAndValueTypes($this->key_union_type, $this->element_union_type, $is_nullable);
    }
    ...
    private function addClassAliases(CodeBase $code_base, UnionTypeBuilder $union_type_builder, FullyQualifiedClassName $class_fqsen) : void
    {
        ...
        foreach ($fqsen_aliases as $alias_fqsen_record) {
            ...
            $union_type_builder->addType(GenericIterableType::fromKeyAndValueTypes($this->key_union_type, $alias_fqsen->asType()->asPHPDocUnionType(), $this->is_nullable));
        }
    }
