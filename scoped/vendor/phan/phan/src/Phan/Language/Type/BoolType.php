...
final class BoolType extends ScalarType
{
    ...
    {
        return \true;
        // it's always falsey, since this is conceptually a collection of FalseType and TrueType
    }
    ...
    {
        return \true;
        // it's possibly false, since this is conceptually a collection of FalseType and TrueType
    }
    ...
    {
        return $other->isInBoolFamily() || $other instanceof MixedType || $other instanceof TemplateType || !$context->isStrictTypes() && parent::canCastToDeclaredType($code_base, $context, $other);
    }
    public function isPossiblyTrue() : bool
    {
        return \true;
        // it's possibly true, since this is conceptually a collection of FalseType and TrueType
    }
    ...
    {
        return self::performComparison(\false, $scalar, $flags) || self::performComparison(\true, $scalar, $flags);
    }
}
