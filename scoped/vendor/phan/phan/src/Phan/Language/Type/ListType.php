...
class ListType extends GenericArrayType
{
     ...
     */
    public static function fromElementType(Type $type, bool $is_nullable, int $key_type = GenericArrayType::KEY_INT) : GenericArrayType
    {
        ...
        if (!$map->contains($type)) {
            $map->attach($type, new ListType($type, $is_nullable));
        }
    ...
    {
        return NonEmptyListType::fromElementType($this->element_type, \false, $this->key_type);
    }
