...
final class NullType extends ScalarType implements LiteralTypeInterface
{
    ...
    {
        parent::__construct($namespace, $name, [], \true);
    }
    public function canCastToNonNullableType(Type $type) : bool
    {
        ...
        return Config::get_null_casts_as_any_type() || Config::get_null_casts_as_array() && $type->isArrayLike() || parent::canCastToNonNullableType($type);
    }
    /**
    ...
    public function canCastToType(Type $type) : bool
    {
        ...
        if ($type->isScalar()) {
            ...
            if (\count($scalar_implicit_partial) > 0 && \in_array($type->getName(), $scalar_implicit_partial['null'] ?? [], \true)) {
                return \true;
            }
        }
        return \false;
