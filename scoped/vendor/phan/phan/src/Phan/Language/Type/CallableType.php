...
final class CallableType extends NativeType implements CallableInterface
{
    ...
    {
        return \true;
        // callable-object, Closure, etc. are objects
    }
    ...
    public function canCastToDeclaredType(CodeBase $code_base, Context $context, Type $other) : bool
    {
        ...
        // TODO: More specific.
        return $other instanceof StringType || $other instanceof ObjectType || $other instanceof IterableType || parent::canCastToDeclaredType($code_base, $context, $other);
    }
}
