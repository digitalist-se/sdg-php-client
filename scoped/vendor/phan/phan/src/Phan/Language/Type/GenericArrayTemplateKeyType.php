...
class GenericArrayTemplateKeyType extends GenericArrayType
{
     ...
     */
    public static function fromTemplateAndElementType(Type $type, bool $is_nullable, UnionType $key_type) : GenericArrayTemplateKeyType
    {
    ...
    public function withTemplateParameterTypeMap(array $template_parameter_type_map) : UnionType
    {
        ...
        if ($this->template_key_type !== $new_key_type) {
            ...
            return $new_element_type->asGenericArrayTypes(GenericArrayType::keyTypeFromUnionTypeValues($new_key_type))->withIsNullable($this->is_nullable);
        }
