...
class PassByReferenceVariable extends Variable
{
     ...
     */
    public function __construct(Variable $parameter, $element, CodeBase $code_base = null, Context $context_of_created_reference = null)
    {
    ...
    public function setUnionType(UnionType $type) : void
    {
        ...
        if ($this->element instanceof Property && $this->code_base) {
            ...
            AssignmentVisitor::addTypesToPropertyStandalone($this->code_base, $this->element->getContext(), $this->element, $type);
            return;
        }
