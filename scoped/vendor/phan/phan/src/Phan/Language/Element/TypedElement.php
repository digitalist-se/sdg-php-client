...
abstract class TypedElement implements TypedElementInterface
{
    ...
    {
        $this->phan_flags = Flags::bitVectorWithState($this->phan_flags, Flags::IS_DEPRECATED, $is_deprecated);
    }
    /**
    ...
    {
        $this->phan_flags = Flags::bitVectorWithState($this->phan_flags, Flags::IS_PHP_INTERNAL, $is_internal);
    }
    /**
