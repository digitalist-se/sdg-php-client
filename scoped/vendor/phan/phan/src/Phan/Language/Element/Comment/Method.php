...
class Method
{
     ...
     * The line of this method
     */
    public function __construct(string $name, UnionType $type, array $parameters, bool $is_static, int $line)
    {
        $this->name = $name;
        $this->type = $type;
    ...
    {
        return \array_reduce($this->parameters, static function (int $carry, Parameter $parameter) : int {
