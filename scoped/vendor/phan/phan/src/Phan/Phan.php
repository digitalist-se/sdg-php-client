...
use SdgScoped\Phan\AST\TolerantASTConverter\Shim;
use SdgScoped\Phan\Daemon\Request;
use SdgScoped\Phan\Language\Element\FunctionInterface;
use SdgScoped\Phan\Language\Type;
use SdgScoped\Phan\LanguageServer\LanguageServer;
use SdgScoped\Phan\LanguageServer\Logger as LanguageServerLogger;
use SdgScoped\Phan\Library\FileCache;
use SdgScoped\Phan\Library\StringUtil;
use SdgScoped\Phan\Output\BufferedPrinterInterface;
use SdgScoped\Phan\Output\Collector\BufferingCollector;
use SdgScoped\Phan\Output\IgnoredFilesFilterInterface;
use SdgScoped\Phan\Output\IssueCollectorInterface;
use SdgScoped\Phan\Output\IssuePrinterInterface;
use SdgScoped\Phan\Plugin\ConfigPluginSet;
use SdgScoped\phpDocumentor\Reflection\DocBlock\StandardTagFactory;
...
class Phan implements IgnoredFilesFilterInterface
{
     ...
     */
    public static function setIssueCollector(IssueCollectorInterface $issue_collector) : void
    {
     ...
     */
    private const DAEMON_PRELOAD_CLASSES = [\SdgScoped\Phan\Analysis\AbstractMethodAnalyzer::class, \SdgScoped\Phan\Analysis\ArgumentType::class, \SdgScoped\Phan\Analysis\AssignmentVisitor::class, \SdgScoped\Phan\Analysis\AssignOperatorAnalysisVisitor::class, \SdgScoped\Phan\Analysis\BlockExitStatusChecker::class, \SdgScoped\Phan\Analysis\ClassInheritanceAnalyzer::class, \SdgScoped\Phan\Analysis\CompositionAnalyzer::class, \SdgScoped\Phan\Analysis\ConditionVisitor::class, \SdgScoped\Phan\Analysis\ConditionVisitor\ComparisonCondition::class, \SdgScoped\Phan\Analysis\ConditionVisitor\IdenticalCondition::class, \SdgScoped\Phan\Analysis\ConditionVisitor\NotIdenticalCondition::class, \SdgScoped\Phan\Analysis\ContextMergeVisitor::class, \SdgScoped\Phan\Analysis\DuplicateClassAnalyzer::class, \SdgScoped\Phan\Analysis\DuplicateFunctionAnalyzer::class, \SdgScoped\Phan\Analysis\FallbackMethodTypesVisitor::class, \SdgScoped\Phan\Analysis\LoopConditionVisitor::class, \SdgScoped\Phan\Analysis\NegatedConditionVisitor::class, \SdgScoped\Phan\Analysis\ParameterTypesAnalyzer::class, \SdgScoped\Phan\Analysis\ParentConstructorCalledAnalyzer::class, \SdgScoped\Phan\Analysis\PostOrderAnalysisVisitor::class, \SdgScoped\Phan\Analysis\PreOrderAnalysisVisitor::class, \SdgScoped\Phan\Analysis\PropertyTypesAnalyzer::class, \SdgScoped\Phan\Analysis\ReachabilityChecker::class, \SdgScoped\Phan\Analysis\RedundantCondition::class, \SdgScoped\Phan\Analysis\RegexAnalyzer::class, \SdgScoped\Phan\Analysis\ThrowsTypesAnalyzer::class, \SdgScoped\Phan\AST\ASTHasher::class, \SdgScoped\Phan\AST\ASTReverter::class, \SdgScoped\Phan\AST\FallbackUnionTypeVisitor::class, \SdgScoped\Phan\AST\InferPureVisitor::class, \SdgScoped\Phan\AST\InferValue::class, \SdgScoped\Phan\AST\ScopeImpactCheckingVisitor::class, \SdgScoped\Phan\BlockAnalysisVisitor::class, \SdgScoped\Phan\Daemon\ParseRequest::class, \SdgScoped\Phan\Daemon\Request::class, \SdgScoped\Phan\Daemon\Transport\StreamResponder::class, \SdgScoped\Phan\Exception\NodeException::class, \SdgScoped\Phan\Language\Element\MarkupDescription::class, \SdgScoped\Phan\Language\Scope\BranchScope::class, \SdgScoped\Phan\Language\Type\NonEmptyAssociativeArrayType::class, \SdgScoped\Phan\Language\Type\NonEmptyGenericArrayType::class, \SdgScoped\Phan\Library\Hasher\Sequential::class, \SdgScoped\Phan\Library\RegexKeyExtractor::class, \SdgScoped\Phan\Ordering::class, \SdgScoped\Phan\Output\Printer\CapturingJSONPrinter::class, \SdgScoped\Phan\Output\Printer\FilteringPrinter::class, \SdgScoped\Phan\Output\Printer\JSONPrinter::class, \SdgScoped\Phan\Plugin\Internal\RedundantConditionLoopCheck::class, \SdgScoped\Phan\Plugin\Internal\UseReturnValuePlugin\RedundantReturnVisitor::class, \SdgScoped\Phan\Plugin\Internal\VariableTracker\VariableGraph::class, \SdgScoped\Phan\Plugin\Internal\VariableTracker\VariableTrackerVisitor::class, \SdgScoped\Phan\Plugin\Internal\VariableTracker\VariableTrackingBranchScope::class, \SdgScoped\Phan\Plugin\Internal\VariableTracker\VariableTrackingLoopScope::class, \SdgScoped\Phan\Plugin\Internal\VariableTracker\VariableTrackingScope::class, \SdgScoped\Phan\PluginV3\StopParamAnalysisException::class, \SdgScoped\Phan\Suggestion::class, \SdgScoped\Symfony\Component\Console\Output\BufferedOutput::class];
    /**
     ...
     */
    public static function analyzeFileList(CodeBase $code_base, Closure $file_path_lister) : bool
    {
        if (Config::getValue('dump_parsed_file_list') === \true) {
        ...
        if (CLI::isDaemonOrLanguageServer() && Config::getValue('language_server_use_pcntl_fallback')) {
        ...
        if ($is_undoable_request) {
            ...
            if (count($analyze_file_path_list) === 0) {
                ...
                // respond and exit.
                exit(0);
                // This is normal (E.g. .txt files, files outside of analysis list, etc)
            }
    ...
    private static function checkLanguageServerDependencies() : void
    {
        ...
        if (\strpos((string) $first_param, 'object') !== \false) {
            throw new AssertionError('Cannot run the Phan language server with phpdocumentor/reflection-docblock 5.0+ and php 7.1. ' . 'Downgrade to phpdocumentor/reflection-docblock=^4.3.4.0 or run Phan with a newer php version.');
        }
    }
    private static function preloadBeforeForkingAnalysisWorkers(CodeBase $code_base) : void
    {
        ...
        $preload_function_state = static function (FunctionInterface $function_or_method) use($code_base) : void {
     ...
     */
    public static function finishAnalyzingRemainingStatements(CodeBase $code_base, ?Request $request, array $analyze_file_path_list, array $temporary_file_mapping) : bool
    {
        try {
            ...
            $code_base->setShouldHydrateRequestedElements(\true);
            ...
            // analysis
            $analyze_file_path_list = array_values(array_filter($analyze_file_path_list, static function (string $file_path) : bool {
                return !self::isExcludedAnalysisFile($file_path);
            }));
            ...
            $process_file_list_map = (new Ordering($code_base))->orderForProcessCount(Config::getValue('processes'), $analyze_file_path_list);
            /**
            ...
            if (!($process_count > 0 && $process_count <= Config::getValue('processes'))) {
                throw new AssertionError("The process count must be between 1 and the given number of processes. After mapping files to cores, {$process_count} process were set to be used.");
            }
            ...
            if ($request instanceof Request) {
                ...
                $request->sendJSONResponse(["status" => Request::STATUS_ERROR_UNKNOWN, "issue_count" => 1, "issues" => 'Failed to analyze files: Uncaught exception: ' . (string) $e]);
    ...
    public static function expandedFileList(CodeBase $code_base, array $file_path_list) : array
    {
        ...
        CLI::progress('dependencies', 0.0, null);
    ...
    public static function isExcludedAnalysisFile(string $file_path) : bool
    {
        ...
        if ($include_analysis_file_list) {
            return !in_array($file_path, $include_analysis_file_list, \true);
        }
     ...
     */
    public static function setPrinter(IssuePrinterInterface $printer) : void
    {
    ...
    private static function loadConfiguredPHPExtensionStubs(CodeBase $code_base) : void
    {
        ...
        foreach ($stubs ?: [] as $extension_name => $path_to_extension) {
            ...
            if (!is_string($path_to_extension)) {
                throw new \InvalidArgumentException("Invalid autoload_internal_extension_signatures: path for {$extension_name} is not a string: value: " . var_export($path_to_extension, \true));
            }
            $path_to_extension = Config::projectPath($path_to_extension);
            if (!is_file($path_to_extension)) {
                throw new \InvalidArgumentException("Invalid autoload_internal_extension_signatures: path for {$extension_name} is not a file: value: " . var_export($path_to_extension, \true));
            }
            Analysis::parseFile($code_base, $path_to_extension, \false, null, \true);
        }
    }
}
