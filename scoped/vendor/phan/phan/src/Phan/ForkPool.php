...
use SdgScoped\Phan\ForkPool\Progress;
use SdgScoped\Phan\ForkPool\Reader;
...
class ForkPool
{
     ...
     */
    public function __construct(array $process_task_data_iterator, Closure $startup_closure, Closure $task_closure, Closure $shutdown_closure)
    {
