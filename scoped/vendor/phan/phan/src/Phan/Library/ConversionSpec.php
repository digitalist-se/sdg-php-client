...
class ConversionSpec
{
     ...
     */
    public const FORMAT_STRING_INNER_REGEX_PART = '%' . '(\\d+\\$)?' . '(' . self::PADDING_STRING_REGEX_PART . ')' . '([+-]?)' . '(\\d*)' . '(\\.\\d*)?' . '(?:l)?' . '([bcdeEfFgGosuxX])';
    // A type specifier
    ...
    public const ARG_TYPE_LOOKUP = ['b' => 'int', 'c' => 'int', 'd' => 'int', 'e' => 'float', 'E' => 'float', 'f' => 'float', 'F' => 'float', 'g' => 'float', 'G' => 'float', 'o' => 'int', 's' => 'string', 'u' => 'int', 'x' => 'int', 'X' => 'int'];
    /**
