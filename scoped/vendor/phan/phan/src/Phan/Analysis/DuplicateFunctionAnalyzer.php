...
class DuplicateFunctionAnalyzer
{
     ...
     */
    public static function analyzeDuplicateFunction(CodeBase $code_base, FunctionInterface $method) : void
    {
        ...
        if ($original_method->isPHPInternal()) {
            ...
            if ($fqsen->getAlternateId() === 1) {
                Issue::maybeEmit($code_base, $original_method->getContext(), Issue::RedefineFunction, $original_method->getFileRef()->getLineNumberStart(), $original_method->getName(), $original_method->getFileRef()->getFile(), $original_method->getFileRef()->getLineNumberStart(), $method->getFileRef()->getFile(), $method->getFileRef()->getLineNumberStart());
            }
        }
    }
}
