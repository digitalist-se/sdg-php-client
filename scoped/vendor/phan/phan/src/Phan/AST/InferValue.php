...
class InferValue
{
    ...
    {
        return @\SdgScoped\with_disabled_phan_error_handler($cb);
    }
    /**
    ...
    public static function computeBinaryOpResult($left, $right, int $flags)
    {
        ...
        return self::evalSuppressingErrors(
            /** @return Node|array|int|string|float|bool|null */
            static function () use($left, $right, $flags) {
                switch ($flags) {
    ...
    public static function computeUnaryOpResult($operand, int $flags)
    {
        ...
        return self::evalSuppressingErrors(
            /** @return Node|array|int|string|float|bool|null */
            static function () use($operand, $flags) {
                switch ($flags) {
