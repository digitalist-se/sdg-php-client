...
use SdgScoped\Phan\Plugin\Internal\UseReturnValuePlugin\PureMethodGraph;
use SdgScoped\Phan\Plugin\Internal\UseReturnValuePlugin\UseReturnValueVisitor;
...
class InferPureVisitor extends AnalysisVisitor
{
    ...
    {
        return new self($code_base, $func->getContext(), self::getLabelForFunction($func), $graph);
    }
    /**
     ...
     */
    protected final function maybeInvoke($node) : void
    {
    ...
    protected final function maybeInvokeAllChildNodes(Node $node) : void
    {
    ...
    public function visitCall(Node $node) : void
    {
        ...
        try {
            $function_list_generator = (new ContextNode($this->code_base, $this->context, $expr))->getFunctionFromNode(\true);
    ...
    public function visitStaticCall(Node $node) : void
    {
        ...
        try {
            $union_type = UnionTypeVisitor::unionTypeFromClassNode($this->code_base, $this->context, $class);
        } catch (Exception $_) {
        ...
        if (!$class->hasMethodWithName($this->code_base, $method, \true)) {
    ...
    {
        $closure_fqsen = FullyQualifiedFunctionName::fromClosureInContext((clone $this->context)->withLineNumberStart($node->lineno), $node);
