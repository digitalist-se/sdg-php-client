...
class PhanAnnotationAdder
{
    ...
    public const FLAGS_NODE_TYPE_SET = [\ast\AST_VAR => \true, \ast\AST_DIM => \true, \ast\AST_PROP => \true, \ast\AST_STATIC_PROP => \true, \ast\AST_ASSIGN => \true, \ast\AST_ASSIGN_REF => \true];
    /**
    ...
    /** @internal */
    public const SCOPE_START_LIST = [\ast\AST_CLASS, \ast\AST_FUNC_DECL, \ast\AST_CLOSURE, \ast\AST_ARROW_FUNC];
    /**
    ...
    private static function applyToScopeInner($node) : void
    {
        if ($node instanceof Node) {
            $kind = $node->kind;
            if (\in_array($kind, self::SCOPE_START_LIST, \true)) {
                return;
            }
