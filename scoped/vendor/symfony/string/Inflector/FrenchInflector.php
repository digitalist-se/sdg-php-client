 ...
 */
namespace SdgScoped\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'SdgScoped\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'SdgScoped\\Mes\\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'SdgScoped\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', 'SdgScoped\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', 'SdgScoped\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', 'SdgScoped\\Mon\\1'],
        //Default rule
        ['/s$/i', ''],
    ];
