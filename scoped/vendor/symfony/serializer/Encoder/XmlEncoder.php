 ...
 */
namespace SdgScoped\Symfony\Component\Serializer\Encoder;
...
class XmlEncoder implements EncoderInterface, DecoderInterface, NormalizationAwareInterface, SerializerAwareInterface
{
    ...
    private $defaultContext = [self::AS_COLLECTION => \false, self::DECODER_IGNORED_NODE_TYPES => [\XML_PI_NODE, \XML_COMMENT_NODE], self::ENCODER_IGNORED_NODE_TYPES => [], self::LOAD_OPTIONS => \LIBXML_NONET | \LIBXML_NOBLANKS, self::REMOVE_EMPTY_TAGS => \false, self::ROOT_NODE_NAME => 'response', self::TYPE_CAST_ATTRIBUTES => \true];
