...
use SdgScoped\Symfony\Component\VarExporter\VarExporter;
/**
    ...
    private function generateDeclaredClassMetadata(array $classMetadatas) : string
    {
        ...
        foreach ($classMetadatas as $classMetadata) {
            ...
            foreach ($classMetadata->getAttributesMetadata() as $attributeMetadata) {
                $attributesMetadata[$attributeMetadata->getName()] = [$attributeMetadata->getGroups(), $attributeMetadata->getMaxDepth(), $attributeMetadata->getSerializedName()];
            }
