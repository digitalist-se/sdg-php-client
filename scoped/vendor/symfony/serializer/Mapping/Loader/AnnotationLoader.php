 ...
 */
namespace SdgScoped\Symfony\Component\Serializer\Mapping\Loader;

use SdgScoped\Doctrine\Common\Annotations\Reader;
use SdgScoped\Symfony\Component\Serializer\Annotation\Context;
use SdgScoped\Symfony\Component\Serializer\Annotation\DiscriminatorMap;
use SdgScoped\Symfony\Component\Serializer\Annotation\Groups;
use SdgScoped\Symfony\Component\Serializer\Annotation\Ignore;
use SdgScoped\Symfony\Component\Serializer\Annotation\MaxDepth;
use SdgScoped\Symfony\Component\Serializer\Annotation\SerializedName;
use SdgScoped\Symfony\Component\Serializer\Exception\MappingException;
use SdgScoped\Symfony\Component\Serializer\Mapping\AttributeMetadata;
use SdgScoped\Symfony\Component\Serializer\Mapping\AttributeMetadataInterface;
use SdgScoped\Symfony\Component\Serializer\Mapping\ClassDiscriminatorMapping;
use SdgScoped\Symfony\Component\Serializer\Mapping\ClassMetadataInterface;
/**
...
{
    private const KNOWN_ANNOTATIONS = [DiscriminatorMap::class, Groups::class, Ignore::class, MaxDepth::class, SerializedName::class, Context::class];
    private $reader;
    ...
    private function isKnownAttribute(string $attributeName) : bool
    {
        foreach (self::KNOWN_ANNOTATIONS as $knownAnnotation) {
            if (\is_a($attributeName, $knownAnnotation, \true)) {
                return \true;
            }
        }
        return \false;
