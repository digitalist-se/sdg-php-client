 ...
 */
namespace SdgScoped\Symfony\Component\Serializer;

use SdgScoped\Symfony\Component\Serializer\Encoder\ChainDecoder;
use SdgScoped\Symfony\Component\Serializer\Encoder\ChainEncoder;
use SdgScoped\Symfony\Component\Serializer\Encoder\ContextAwareDecoderInterface;
use SdgScoped\Symfony\Component\Serializer\Encoder\ContextAwareEncoderInterface;
use SdgScoped\Symfony\Component\Serializer\Encoder\DecoderInterface;
use SdgScoped\Symfony\Component\Serializer\Encoder\EncoderInterface;
...
use SdgScoped\Symfony\Component\Serializer\Exception\NotEncodableValueException;
use SdgScoped\Symfony\Component\Serializer\Exception\NotNormalizableValueException;
use SdgScoped\Symfony\Component\Serializer\Exception\PartialDenormalizationException;
use SdgScoped\Symfony\Component\Serializer\Normalizer\AbstractObjectNormalizer;
use SdgScoped\Symfony\Component\Serializer\Normalizer\CacheableSupportsMethodInterface;
use SdgScoped\Symfony\Component\Serializer\Normalizer\ContextAwareDenormalizerInterface;
use SdgScoped\Symfony\Component\Serializer\Normalizer\ContextAwareNormalizerInterface;
...
class Serializer implements SerializerInterface, ContextAwareNormalizerInterface, ContextAwareDenormalizerInterface, ContextAwareEncoderInterface, ContextAwareDecoderInterface
{
     ...
     * {@inheritdoc}
     */
    public final function serialize($data, string $format, array $context = []) : string
    {
     ...
     * {@inheritdoc}
     */
    public final function deserialize($data, string $type, string $format, array $context = [])
    {
     ...
     * {@inheritdoc}
     */
    public final function decode(string $data, string $format, array $context = [])
    {
