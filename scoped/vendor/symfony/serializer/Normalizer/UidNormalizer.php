...
use SdgScoped\Symfony\Component\Uid\AbstractUid;
use SdgScoped\Symfony\Component\Uid\Uuid;
final class UidNormalizer implements NormalizerInterface, DenormalizerInterface, CacheableSupportsMethodInterface
{
    ...
    private $defaultContext = [self::NORMALIZATION_FORMAT_KEY => self::NORMALIZATION_FORMAT_CANONICAL];
    ...
    {
        return \is_a($type, AbstractUid::class, \true);
    }
    /**
     * {@inheritdoc}
     */
