...
use SdgScoped\Symfony\Component\Serializer\Exception\CircularReferenceException;
...
use SdgScoped\Symfony\Component\Serializer\Exception\MissingConstructorArgumentsException;
use SdgScoped\Symfony\Component\Serializer\Exception\NotNormalizableValueException;
use SdgScoped\Symfony\Component\Serializer\Exception\RuntimeException;
...
use SdgScoped\Symfony\Component\Serializer\SerializerAwareTrait;
/**
        ...
        if ($constructor) {
            ...
            foreach ($constructorParameters as $constructorParameter) {
                ...
                if ($constructorParameter->isVariadic()) {
                    ...
                    $exception = NotNormalizableValueException::createForUnexpectedDataType(\sprintf('Failed to create object because the object miss the "%s" property.', $constructorParameter->name), $data, ['unknown'], $context['deserialization_path'] ?? null, \true);
                    $context['not_normalizable_value_exceptions'][] = $exception;
                    return $reflectionClass->newInstanceWithoutConstructor();
                }
            }
