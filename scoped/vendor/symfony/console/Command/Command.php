 ...
 */
namespace SdgScoped\Symfony\Component\Console\Command;

use SdgScoped\Symfony\Component\Console\Application;
use SdgScoped\Symfony\Component\Console\Attribute\AsCommand;
...
class Command
{
    ...
    public function run(InputInterface $input, OutputInterface $output)
    {
        ...
        if (null !== $this->processTitle) {
            ...
            } elseif (\function_exists('SdgScoped\\setproctitle')) {
