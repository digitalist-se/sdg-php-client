...
namespace SdgScoped\Jane\OpenApiCommon\Guesser;
    ...
    public function resolve(Reference $reference, string $class) : array
    {
        ...
        do {
            ...
            $result = $result->resolve(function ($data) use($result, $class) {
                return $this->denormalizer->denormalize($data, $class, 'json', ['document-origin' => (string) $result->getMergedUri()->withFragment('')]);
            });
