...
use SdgScoped\Jane\OpenApi2\JaneOpenApi as OpenApi2Base;
use SdgScoped\Jane\OpenApi3\JaneOpenApi as OpenApi3Base;
    ...
    private function isOpenApi2(string $origin) : array
    {
        ...
        if (\class_exists(OpenApi2Base::class)) {
            if (!\array_key_exists(OpenApi2Base::class, $this->schemaParsers)) {
                ...
                $this->schemaParsers[OpenApi2Base::class] = new \SdgScoped\Jane\OpenApi2\SchemaParser\SchemaParser($openApi2Serializer);
            }
            try {
    ...
    private function isOpenApi3(string $origin) : array
    {
        ...
        if (\class_exists(OpenApi3Base::class)) {
            if (!\array_key_exists(OpenApi3Base::class, $this->schemaParsers)) {
                ...
                $this->schemaParsers[OpenApi3Base::class] = new \SdgScoped\Jane\OpenApi3\SchemaParser\SchemaParser($openApi3Serializer);
            }
            try {
