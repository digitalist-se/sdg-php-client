...
class MediaTypeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\OpenApi3\\JsonSchema\\Model\\MediaType';
    }
    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \SdgScoped\Jane\OpenApi3\JsonSchema\Model\MediaType;
    }
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \SdgScoped\Jane\OpenApi3\JsonSchema\Model\MediaType();
        ...
        if (\array_key_exists('examples', $data) && $data['examples'] !== null) {
            ...
            foreach ($data['examples'] as $key => $value_1) {
                ...
                if (\is_array($value_1) and isset($value_1['$ref'])) {
                    ...
                    $value_2 = $this->denormalizer->denormalize($value_1, 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Example', 'json', $context);
                }
                $values[$key] = $value_2;
            }
        ...
        if (\array_key_exists('encoding', $data) && $data['encoding'] !== null) {
            ...
            foreach ($data['encoding'] as $key_1 => $value_3) {
                $values_1[$key_1] = $this->denormalizer->denormalize($value_3, 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Encoding', 'json', $context);
            }
