...
class ClientCredentialsFlowNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof \SdgScoped\Jane\OpenApi3\JsonSchema\Model\ClientCredentialsFlow;
    }
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \SdgScoped\Jane\OpenApi3\JsonSchema\Model\ClientCredentialsFlow();
