...
class OpenApiNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\OpenApi3\\JsonSchema\\Model\\OpenApi';
    }
    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \SdgScoped\Jane\OpenApi3\JsonSchema\Model\OpenApi;
    }
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \SdgScoped\Jane\OpenApi3\JsonSchema\Model\OpenApi();
        ...
        if (\array_key_exists('info', $data) && $data['info'] !== null) {
            $object->setInfo($this->denormalizer->denormalize($data['info'], 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Info', 'json', $context));
            unset($data['info']);
        ...
        if (\array_key_exists('tags', $data) && $data['tags'] !== null) {
            ...
            foreach ($data['tags'] as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Tag', 'json', $context);
            }
        ...
        if (\array_key_exists('paths', $data) && $data['paths'] !== null) {
            ...
            foreach ($data['paths'] as $key_1 => $value_5) {
                if (\preg_match('/^\\//', (string) $key_1) && \is_array($value_5)) {
                    $values_5[$key_1] = $this->denormalizer->denormalize($value_5, 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\PathItem', 'json', $context);
                    continue;
                }
        ...
        if (\array_key_exists('components', $data) && $data['components'] !== null) {
            $object->setComponents($this->denormalizer->denormalize($data['components'], 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Components', 'json', $context));
