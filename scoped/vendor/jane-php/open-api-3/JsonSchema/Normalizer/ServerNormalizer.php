...
class ServerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\OpenApi3\\JsonSchema\\Model\\Server';
    }
    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \SdgScoped\Jane\OpenApi3\JsonSchema\Model\Server;
    }
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \SdgScoped\Jane\OpenApi3\JsonSchema\Model\Server();
        ...
        if (\array_key_exists('variables', $data) && $data['variables'] !== null) {
            ...
            foreach ($data['variables'] as $key => $value) {
                $values[$key] = $this->denormalizer->denormalize($value, 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\ServerVariable', 'json', $context);
            }
