...
class InfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof \SdgScoped\Jane\OpenApi3\JsonSchema\Model\Info;
    }
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \SdgScoped\Jane\OpenApi3\JsonSchema\Model\Info();
        ...
        if (\array_key_exists('contact', $data) && $data['contact'] !== null) {
            $object->setContact($this->denormalizer->denormalize($data['contact'], 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Contact', 'json', $context));
            unset($data['contact']);
        ...
        if (\array_key_exists('license', $data) && $data['license'] !== null) {
            $object->setLicense($this->denormalizer->denormalize($data['license'], 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\License', 'json', $context));
            unset($data['license']);
