...
class LinkNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof \SdgScoped\Jane\OpenApi3\JsonSchema\Model\Link;
    }
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \SdgScoped\Jane\OpenApi3\JsonSchema\Model\Link();
        ...
        if (\array_key_exists('server', $data) && $data['server'] !== null) {
            $object->setServer($this->denormalizer->denormalize($data['server'], 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Server', 'json', $context));
            unset($data['server']);
