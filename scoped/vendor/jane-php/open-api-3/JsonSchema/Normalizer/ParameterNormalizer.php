...
class ParameterNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\OpenApi3\\JsonSchema\\Model\\Parameter';
    }
    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \SdgScoped\Jane\OpenApi3\JsonSchema\Model\Parameter;
    }
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \SdgScoped\Jane\OpenApi3\JsonSchema\Model\Parameter();
        ...
        if (\array_key_exists('schema', $data) && $data['schema'] !== null) {
            ...
            if (\is_array($data['schema']) and isset($data['schema']['$ref'])) {
                $value = $this->denormalizer->denormalize($data['schema'], 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Reference', 'json', $context);
            } elseif (\is_array($data['schema'])) {
                $value = $this->denormalizer->denormalize($data['schema'], 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Schema', 'json', $context);
            }
        ...
        if (\array_key_exists('content', $data) && $data['content'] !== null) {
            ...
            foreach ($data['content'] as $key => $value_1) {
                $values[$key] = $this->denormalizer->denormalize($value_1, 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\MediaType', 'json', $context);
            }
        ...
        if (\array_key_exists('examples', $data) && $data['examples'] !== null) {
            ...
            foreach ($data['examples'] as $key_1 => $value_2) {
                ...
                if (\is_array($value_2) and isset($value_2['$ref'])) {
                    ...
                    $value_3 = $this->denormalizer->denormalize($value_2, 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Example', 'json', $context);
                }
