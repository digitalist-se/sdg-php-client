...
class SchemaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\OpenApi3\\JsonSchema\\Model\\Schema';
    }
    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \SdgScoped\Jane\OpenApi3\JsonSchema\Model\Schema;
    }
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \SdgScoped\Jane\OpenApi3\JsonSchema\Model\Schema();
        ...
        if (\array_key_exists('not', $data) && $data['not'] !== null) {
            ...
            if (\is_array($data['not']) and isset($data['not']['$ref'])) {
                $value_2 = $this->denormalizer->denormalize($data['not'], 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Reference', 'json', $context);
            } elseif (\is_array($data['not'])) {
                $value_2 = $this->denormalizer->denormalize($data['not'], 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Schema', 'json', $context);
            }
        ...
        if (\array_key_exists('allOf', $data) && $data['allOf'] !== null) {
            ...
            foreach ($data['allOf'] as $value_3) {
                ...
                if (\is_array($value_3) and isset($value_3['$ref'])) {
                    ...
                    $value_4 = $this->denormalizer->denormalize($value_3, 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Schema', 'json', $context);
                }
                $values_2[] = $value_4;
            }
        ...
        if (\array_key_exists('oneOf', $data) && $data['oneOf'] !== null) {
            ...
            foreach ($data['oneOf'] as $value_5) {
                ...
                if (\is_array($value_5) and isset($value_5['$ref'])) {
                    $value_6 = $this->denormalizer->denormalize($value_5, 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Reference', 'json', $context);
                } elseif (\is_array($value_5)) {
                    $value_6 = $this->denormalizer->denormalize($value_5, 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Schema', 'json', $context);
                }
                $values_3[] = $value_6;
            }
        ...
        if (\array_key_exists('anyOf', $data) && $data['anyOf'] !== null) {
            ...
            foreach ($data['anyOf'] as $value_7) {
                ...
                if (\is_array($value_7) and isset($value_7['$ref'])) {
                    $value_8 = $this->denormalizer->denormalize($value_7, 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Reference', 'json', $context);
                } elseif (\is_array($value_7)) {
                    $value_8 = $this->denormalizer->denormalize($value_7, 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Schema', 'json', $context);
                }
                $values_4[] = $value_8;
            }
        ...
        if (\array_key_exists('items', $data) && $data['items'] !== null) {
            ...
            if (\is_array($data['items']) and isset($data['items']['$ref'])) {
                $value_9 = $this->denormalizer->denormalize($data['items'], 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Reference', 'json', $context);
            } elseif (\is_array($data['items'])) {
                $value_9 = $this->denormalizer->denormalize($data['items'], 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Schema', 'json', $context);
            }
        ...
        if (\array_key_exists('properties', $data) && $data['properties'] !== null) {
            ...
            foreach ($data['properties'] as $key => $value_10) {
                ...
                if (\is_array($value_10) and isset($value_10['$ref'])) {
                    ...
                    $value_11 = $this->denormalizer->denormalize($value_10, 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Schema', 'json', $context);
                }
        ...
        if (\array_key_exists('additionalProperties', $data) && $data['additionalProperties'] !== null) {
            ...
            if (\is_array($data['additionalProperties']) and isset($data['additionalProperties']['$ref'])) {
                $value_12 = $this->denormalizer->denormalize($data['additionalProperties'], 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Reference', 'json', $context);
            } elseif (\is_array($data['additionalProperties'])) {
                $value_12 = $this->denormalizer->denormalize($data['additionalProperties'], 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Schema', 'json', $context);
        ...
        if (\array_key_exists('discriminator', $data) && $data['discriminator'] !== null) {
            $object->setDiscriminator($this->denormalizer->denormalize($data['discriminator'], 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Discriminator', 'json', $context));
        ...
        if (\array_key_exists('externalDocs', $data) && $data['externalDocs'] !== null) {
            $object->setExternalDocs($this->denormalizer->denormalize($data['externalDocs'], 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\ExternalDocumentation', 'json', $context));
        ...
        if (\array_key_exists('xml', $data) && $data['xml'] !== null) {
            $object->setXml($this->denormalizer->denormalize($data['xml'], 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\XML', 'json', $context));
            unset($data['xml']);
