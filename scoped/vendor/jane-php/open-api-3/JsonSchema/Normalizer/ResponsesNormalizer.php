...
class ResponsesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\OpenApi3\\JsonSchema\\Model\\Responses';
    }
    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \SdgScoped\Jane\OpenApi3\JsonSchema\Model\Responses;
    }
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \SdgScoped\Jane\OpenApi3\JsonSchema\Model\Responses();
        if (\array_key_exists('default', $data) && $data['default'] !== null) {
            $value = $data['default'];
            if (\is_array($data['default']) and isset($data['default']['$ref'])) {
                $value = $this->denormalizer->denormalize($data['default'], 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Reference', 'json', $context);
            } elseif (\is_array($data['default']) and isset($data['default']['description'])) {
                $value = $this->denormalizer->denormalize($data['default'], 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Response', 'json', $context);
            }
        ...
        foreach ($data as $key => $value_1) {
            if (\preg_match('/^[1-9](?:\\d{2}|XX)$/', (string) $key)) {
                ...
                if (\is_array($value_1) and isset($value_1['$ref'])) {
                    ...
                    $value_2 = $this->denormalizer->denormalize($value_1, 'SdgScoped\\Jane\\OpenApi3\\JsonSchema\\Model\\Response', 'json', $context);
                }
                $object[$key] = $value_2;
            }
