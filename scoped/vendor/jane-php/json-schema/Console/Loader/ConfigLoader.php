...
class ConfigLoader implements ConfigLoaderInterface
{
    ...
    {
        return [$this->fileKey(), 'root-class', 'namespace', 'directory'];
    }
    protected function resolveConfigurationDefaults() : array
    {
        return ['reference' => \true, 'strict' => \true, 'date-format' => \DateTime::RFC3339, 'full-date-format' => 'Y-m-d', 'date-prefer-interface' => null, 'date-input-format' => null, 'use-fixer' => \false, 'fixer-config-file' => null, 'clean-generated' => \true, 'use-cacheable-supports-method' => null, 'skip-null-values' => \true];
    }
}
