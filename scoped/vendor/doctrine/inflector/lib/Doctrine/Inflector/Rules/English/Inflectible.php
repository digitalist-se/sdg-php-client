...
class Inflectible
{
    ...
    {
        (yield new Transformation(new Pattern('(s)tatuses$'), 'SdgScoped\\1\\2tatus'));
        (yield new Transformation(new Pattern('(s)tatus$'), 'SdgScoped\\1\\2tatus'));
        (yield new Transformation(new Pattern('(c)ampus$'), 'SdgScoped\\1\\2ampus'));
        (yield new Transformation(new Pattern('^(.*)(menu)s$'), 'SdgScoped\\1\\2'));
        ...
        (yield new Transformation(new Pattern('(m)ovies$'), 'SdgScoped\\1\\2ovie'));
        (yield new Transformation(new Pattern('(s)eries$'), 'SdgScoped\\1\\2eries'));
        ...
        (yield new Transformation(new Pattern('(analy|diagno|^ba|(p)arenthe|(p)rogno|(s)ynop|(t)he)ses$'), 'SdgScoped\\1\\2sis'));
        ...
        (yield new Transformation(new Pattern('(p)eople$'), 'SdgScoped\\1\\2erson'));
        (yield new Transformation(new Pattern('(m)en$'), '\\1an'));
        (yield new Transformation(new Pattern('(c)hildren$'), 'SdgScoped\\1\\2hild'));
        (yield new Transformation(new Pattern('(f)eet$'), '\\1oot'));
        (yield new Transformation(new Pattern('(n)ews$'), 'SdgScoped\\1\\2ews'));
    ...
    {
        (yield new Transformation(new Pattern('(s)tatus$'), 'SdgScoped\\1\\2tatuses'));
        (yield new Transformation(new Pattern('(quiz)$'), '\\1zes'));
        (yield new Transformation(new Pattern('^(ox)$'), 'SdgScoped\\1\\2en'));
        ...
        (yield new Transformation(new Pattern('(?:([^f])fe|([lr])f)$'), 'SdgScoped\\1\\2ves'));
        ...
        (yield new Transformation(new Pattern('(buffal|her|potat|tomat|volcan)o$'), 'SdgScoped\\1\\2oes'));
