...
namespace SdgScoped\GuzzleHttp\Handler;

use SdgScoped\GuzzleHttp\Exception\ConnectException;
use SdgScoped\GuzzleHttp\Exception\RequestException;
use SdgScoped\GuzzleHttp\Promise as P;
use SdgScoped\GuzzleHttp\Promise\FulfilledPromise;
use SdgScoped\GuzzleHttp\Promise\PromiseInterface;
use SdgScoped\GuzzleHttp\Psr7\LazyOpenStream;
use SdgScoped\GuzzleHttp\TransferStats;
use SdgScoped\GuzzleHttp\Utils;
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf) : void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \SdgScoped\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \SdgScoped\GuzzleHttp\Psr7\Utils::streamFor($sink);
