...
use SdgScoped\GuzzleHttp\Cookie\CookieJar;
use SdgScoped\GuzzleHttp\Exception\GuzzleException;
use SdgScoped\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \SdgScoped\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
