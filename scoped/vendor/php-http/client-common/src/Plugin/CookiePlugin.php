...
use SdgScoped\Http\Message\Cookie;
use SdgScoped\Http\Message\CookieJar;
use SdgScoped\Http\Message\CookieUtil;
use SdgScoped\Http\Message\Exception\UnexpectedValueException;
