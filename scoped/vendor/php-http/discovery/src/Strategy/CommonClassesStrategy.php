...
use SdgScoped\GuzzleHttp\Promise\Promise;
use SdgScoped\GuzzleHttp\Psr7\Request as GuzzleRequest;
use SdgScoped\Http\Client\HttpAsyncClient;
use SdgScoped\Http\Client\HttpClient;
use SdgScoped\Http\Discovery\Exception\NotFoundException;
use SdgScoped\Http\Discovery\MessageFactoryDiscovery;
use SdgScoped\Http\Discovery\Psr17FactoryDiscovery;
use SdgScoped\Http\Message\RequestFactory;
use SdgScoped\Psr\Http\Message\RequestFactoryInterface as Psr17RequestFactory;
use SdgScoped\Http\Message\MessageFactory;
use SdgScoped\Http\Message\MessageFactory\GuzzleMessageFactory;
use SdgScoped\Http\Message\StreamFactory;
use SdgScoped\Http\Message\StreamFactory\GuzzleStreamFactory;
use SdgScoped\Http\Message\UriFactory;
use SdgScoped\Http\Message\UriFactory\GuzzleUriFactory;
use SdgScoped\Http\Message\MessageFactory\DiactorosMessageFactory;
use SdgScoped\Http\Message\StreamFactory\DiactorosStreamFactory;
use SdgScoped\Http\Message\UriFactory\DiactorosUriFactory;
use SdgScoped\Psr\Http\Client\ClientInterface as Psr18Client;
use SdgScoped\Zend\Diactoros\Request as ZendDiactorosRequest;
use SdgScoped\Laminas\Diactoros\Request as DiactorosRequest;
use SdgScoped\Http\Message\MessageFactory\SlimMessageFactory;
use SdgScoped\Http\Message\StreamFactory\SlimStreamFactory;
use SdgScoped\Http\Message\UriFactory\SlimUriFactory;
use SdgScoped\Slim\Http\Request as SlimRequest;
use SdgScoped\GuzzleHttp\Client as GuzzleHttp;
use SdgScoped\Http\Adapter\Guzzle7\Client as Guzzle7;
use SdgScoped\Http\Adapter\Guzzle6\Client as Guzzle6;
use SdgScoped\Http\Adapter\Guzzle5\Client as Guzzle5;
use SdgScoped\Http\Client\Curl\Client as Curl;
use SdgScoped\Http\Client\Socket\Client as Socket;
use SdgScoped\Http\Adapter\React\Client as React;
use SdgScoped\Http\Adapter\Buzz\Client as Buzz;
use SdgScoped\Http\Adapter\Cake\Client as Cake;
use SdgScoped\Http\Adapter\Zend\Client as Zend;
use SdgScoped\Http\Adapter\Artax\Client as Artax;
use SdgScoped\Symfony\Component\HttpClient\HttplugClient as SymfonyHttplug;
use SdgScoped\Symfony\Component\HttpClient\Psr18Client as SymfonyPsr18;
use SdgScoped\Nyholm\Psr7\Factory\HttplugFactory as NyholmHttplugFactory;
/**
 * @internal
 *
...
final class CommonClassesStrategy implements DiscoveryStrategy
{
    ...
    {
        return new \SdgScoped\Buzz\Client\FileGetContents(MessageFactoryDiscovery::find());
    }
