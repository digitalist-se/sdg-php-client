...
use SdgScoped\Http\Discovery\Exception\ClassInstantiationFailedException;
use SdgScoped\Http\Discovery\Exception\DiscoveryFailedException;
use SdgScoped\Http\Discovery\Exception\NoCandidateFoundException;
use SdgScoped\Http\Discovery\Exception\StrategyUnavailableException;
/**
