...
class FeedbackBatchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \SdgScoped\Digitalist\Library\FeedbackQualitySurvey\Model\FeedbackBatch();
        if (\array_key_exists('uniqueId', $data)) {
            $object->setUniqueId($data['uniqueId']);
        }
        if (\array_key_exists('referencePeriod', $data)) {
            $object->setReferencePeriod($this->denormalizer->denormalize($data['referencePeriod'], 'SdgScoped\\Digitalist\\Library\\FeedbackQualitySurvey\\Model\\ReferencePeriod', 'json', $context));
        }
        ...
        if (\array_key_exists('feedbacks', $data)) {
            ...
            foreach ($data['feedbacks'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'SdgScoped\\Digitalist\\Library\\FeedbackQualitySurvey\\Model\\Feedback', 'json', $context);
            }
