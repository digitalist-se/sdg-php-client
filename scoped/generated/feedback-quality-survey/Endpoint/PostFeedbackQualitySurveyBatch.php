...
class PostFeedbackQualitySurveyBatch extends \SdgScoped\Jane\OpenApiRuntime\Client\BaseEndpoint implements \SdgScoped\Jane\OpenApiRuntime\Client\Endpoint
{
    /**
     ...
     */
    public function __construct(\SdgScoped\Digitalist\Library\FeedbackQualitySurvey\Model\FeedbackBatch $requestBody)
    {
    ...
    {
        if ($this->body instanceof \SdgScoped\Digitalist\Library\FeedbackQualitySurvey\Model\FeedbackBatch) {
