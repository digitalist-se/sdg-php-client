...
namespace SdgScoped\Digitalist\Library\StatisticsInformation;
...
class Client extends \SdgScoped\Jane\OpenApiRuntime\Client\Client
{
     ...
     */
    public function postStatisticsInformationService(\SdgScoped\Digitalist\Library\StatisticsInformation\Model\InformationServiceStats $requestBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \SdgScoped\Digitalist\Library\StatisticsInformation\Endpoint\PostStatisticsInformationService($requestBody), $fetch);
    }
    public static function create($httpClient = null, array $additionalPlugins = array())
    {
        ...
        $serializer = new \SdgScoped\Symfony\Component\Serializer\Serializer(array(new \SdgScoped\Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \SdgScoped\Digitalist\Library\StatisticsInformation\Normalizer\JaneObjectNormalizer()), array(new \SdgScoped\Symfony\Component\Serializer\Encoder\JsonEncoder(new \SdgScoped\Symfony\Component\Serializer\Encoder\JsonEncode(), new \SdgScoped\Symfony\Component\Serializer\Encoder\JsonDecode(array('json_decode_associative' => \true)))));
