...
namespace SdgScoped\Digitalist\Library\StatisticsInformation\Endpoint;

class PostStatisticsInformationService extends \SdgScoped\Jane\OpenApiRuntime\Client\BaseEndpoint implements \SdgScoped\Jane\OpenApiRuntime\Client\Endpoint
{
    /**
     ...
     */
    public function __construct(\SdgScoped\Digitalist\Library\StatisticsInformation\Model\InformationServiceStats $requestBody)
    {
    ...
    {
        if ($this->body instanceof \SdgScoped\Digitalist\Library\StatisticsInformation\Model\InformationServiceStats) {
