...
class FeedbackBatchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('referencePeriod', $data)) {
            $object->setReferencePeriod($this->denormalizer->denormalize($data['referencePeriod'], 'Digitalist\\Library\\FeedbackQuality\\Model\\ReferencePeriod', 'json', $context));
        }
        ...
        if (\array_key_exists('feedbacks', $data)) {
            ...
            foreach ($data['feedbacks'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Digitalist\\Library\\FeedbackQuality\\Model\\Feedback', 'json', $context);
            }
